...
///////////////////////////////////////////////////////////////////////////////
#pragma once
#ifndef INCLUDE_CAKE_OWNER_H
    #define INCLUDE_CAKE_OWNER_H
...
// #define CAKE_OWNER_THREAD_SAFE
    ...
    #define CAKE_NO_DISCARD [[nodiscard]]
    #define CAKE_UNUSED(v) ((void)v)
    #define CAKE_IS_ARRAY(type) std::is_array_v<type>
    #define CAKE_EXTENT(type) std::extent_v<type>
    #define CAKE_CONSTEXPR(expr) constexpr(expr)
...
namespace cake {
    ...
    namespace detail {
        ...
        constexpr bool is_owner_valid_type =
            !CAKE_IS_ARRAY(Ty) || (CAKE_IS_ARRAY(Ty) && CAKE_EXTENT(Ty) == 0);
    ...
    class owner_ptr {
       ...
       public:
        ...
        CAKE_NO_DISCARD bool operator==(
            const cake::owner_ptr<Type2, AtomicType2>& _Right) const noexcept {
...
CAKE_NO_DISCARD bool operator==(const SP& _Left, std::nullptr_t) noexcept {
    return !_Left;
}

template <cake::owner_smart_ptr SP>
CAKE_NO_DISCARD bool operator==(std::nullptr_t, const SP& _Right) noexcept {
    return !_Right;
}
...
template <cake::owner_smart_ptr SP>
CAKE_NO_DISCARD bool operator!=(std::nullptr_t _Left,
...
template <cake::owner_smart_ptr SP>
CAKE_NO_DISCARD bool operator>=(std::nullptr_t _Left, const SP& _Right) {
    return !(_Left < _Right);
}

template <cake::owner_smart_ptr SP>
CAKE_NO_DISCARD bool operator>(const SP& _Left, std::nullptr_t _Right) {
    return _Right < _Left;
}
...
template <cake::owner_smart_ptr SP>
CAKE_NO_DISCARD bool operator==(const SP& _Left,
                                const typename SP::Type* const _ptr) noexcept {
    return _Left.hashkey() == _ptr;
}

template <cake::owner_smart_ptr SP>
CAKE_NO_DISCARD bool operator==(const typename SP::Type* _ptr,
                                const SP& _Right) noexcept {
...
template <cake::owner_smart_ptr SP>
CAKE_NO_DISCARD bool operator!=(const typename SP::Type* _Left,
                                const SP& _Right) noexcept {
    return !(_Left == _Right);
}
...
template <cake::owner_smart_ptr SP>
CAKE_NO_DISCARD bool operator==(typename SP::Type* const _ptr,
                                const SP& _Right) noexcept {
    return _Right.hashkey() == _ptr;
}
...
template <cake::owner_smart_ptr SP>
CAKE_NO_DISCARD bool operator!=(typename SP::Type* const _Left,
                                const SP& _Right) noexcept {
    return !(_Left == _Right);
}
